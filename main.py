...
from Problems import NQueensSearch, NPuzzlesSearch
...
if __name__ == "__main__":
    ...
    test = localSearch()
    Nqueen = NQueensSearch(args.n)
    Npuzzle = NPuzzlesSearch(args.n)
    algorithms = [hill_climbing, random_restart, simulated_annealing,hill_climbing, random_restart, simulated_annealing]
    names = ["hill_climbing", "hc_random_restart", "simulated_annealing","hill_climbing", "hc_random_restart", "simulated_annealing"]
    problems = [Nqueen, Nqueen, Nqueen, Npuzzle, Npuzzle, Npuzzle]
